...
document.getElementById('sendButton').addEventListener('click', sendMessage);
    ...
    onValue(leaderboardRef, (snapshot) => {
        ...
        users.forEach((userData, index) => {
            ...
            coinsDiv.innerHTML = `${formatNumber(userData.coins)} <img src='coin.svg' draggable="false" style='width: calc(var(--s) * 0.9); margin: 0; margin-left: calc(var(--s) * 0.1); transform: translateY(20%);'/>`;
...
function updateLeaderboardPrestigeCount() {
    ...
    onValue(leaderboardRef, (snapshot) => {
        ...
        users.forEach((userData, index) => {
            ...
            prestigeCountDiv.innerHTML = `${formatNumber(userData.prestigeCount)} <img src='prestige.svg' draggable="false" style='width: calc(var(--s) * 0.9); margin: 0; margin-left: calc(var(--s) * 0.1); transform: translateY(20%);'/>`;
